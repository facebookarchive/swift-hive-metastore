...
## SWIFT-HIVE-METASTORE
##
## Swift allows API composition, so we do not need this
##
...
##
##
## In a bout of utter irony, we actually revert HIVE-4322 which was contributed and
...
## SWIFT-HIVE-METASTORE
##
  13: optional bool statsFresh                       // statistics is fresh.
##
## SWIFT-HIVE-METASTORE
##
}
...
## SWIFT-HIVE-METASTORE
##
  14: optional TableIdentifier linkTarget,      // the Managed Table this link table points to, null if not a link table
  15: optional list<TableIdentifier> linkTables // all link tables pointing to this table. Only Managed Tables can have links to them.
##
## SWIFT-HIVE-METASTORE
##
}
...
## SWIFT-HIVE-METASTORE
##
  9: optional PartitionIdentifier linkTarget,
  10: optional list<PartitionIdentifier> linkPartitions
##
## SWIFT-HIVE-METASTORE
##
}
...
##
{
  ...
  // drops the table, view or tablelink and all the partitions associated with it if it has partitions
...
##
##
## The signature of this method was changed. See below.
##
