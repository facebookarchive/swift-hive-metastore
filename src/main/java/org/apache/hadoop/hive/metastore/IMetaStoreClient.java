...
public interface IMetaStoreClient {
  ...
  public Partition getPartitionTemplate(String tableName, String dbName,
      List<String> partVals) throws InvalidObjectException, MetaException, TException;
   ...
   * @param destdb
   * @param destTableName
   * @param overwrite destination partition
   * @return list of newly created partition objects
   * @throws InvalidOperationException
   */
  public List<Partition> exchange_partition(Map<String, String> partitionSpecs,
      String sourceDb, String sourceTable, String destdb,
      String destTableName, boolean overwrite) throws MetaException, NoSuchObjectException,
      InvalidObjectException, TException, InvalidInputException, AlreadyExistsException, InvalidOperationException;
  ...
  public int getTotalPartitions(String db_name, String tbl_name)
      throws MetaException, TException;
  ...
  */
   ...
   * @param tblName
   *          Name of the table to fetch.
   * @return  A boolean value to indicate if table exists or not.
   * @throws MetaException
   *          Could not query table information.
   * @throws TException
   *          A thrift communication error occurred.
   */
