...
public class ProtectMode {
  ...
  public static final String FLAG_NO_DROP = "NO_DROP";
  public static final String FLAG_NO_DROP_CASCADE = "NO_DROP_CASCADE";
  public static final String FLAG_READ_ONLY = "READ_ONLY";
